const LocationInfo = ({ currentLocation }) => {
    return (
        <section className="flex flex-col items-center bg-light-yellow mt-4 p-4 rounded-3xl text-black shadow-md gap-2 w-[260px] min-[500px]:w-full min-[500px]:max-w-[1024px]">
